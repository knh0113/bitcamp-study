    ...
    if (member == null) {
      ...
      out.printf("<tr><th style='width:120px;'>사진</th>" + " <td style='width:300px;'>"
          + (member.getPhoto() == null ? "<img style='height:80px' src='/images/avatar.png'>"
              : "<a href='https://kr.object.ncloudstorage.com/bitcamp-nc7-bucket-20/board/745dbe63-b189-40de-b4bb-d64cbd828e79'>"
                  + "<img src='http://nivyeqssijas19010737.cdn.ntruss.com/member/%s?type=f&w=60&h=80&faceopt=true&ttype=jpg'>"
                  + "</a>")

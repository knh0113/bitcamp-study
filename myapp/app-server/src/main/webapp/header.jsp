...
<%
    ...
    if(loginUser.getPhoto() == null) {
      ...
      out.println(String.format("<img src='http://mvsenqskbqzl19010704.cdn.ntruss.com/member/%s?type=f&w=30&h=40&faceopt=true&ttype=jpg'>",
                              loginUser.getPhoto()));
    }
    out.println(String.format("%s %s <a href='/auth/logout'>로그아웃</a>", loginUser.getName()));
    }
%>

...
public class Exam0140 {
  ...
  public static void main(String[] args) {
    ...
    A p = new A(); // A클래스의 인스턴스 만들때 non-static 변수인 v2가 heap에생성되고 그 주소를 레퍼런스 변수p에 저장한다.
    ...
    p.v2 = 200; // OK! //레퍼런스p가 가르키는 인스턴스 변수 v2에 200을 저장

    // 인스턴스 변수는 인스턴스를 만들 때 마다 생성된다.
    A p2 = new A(); // 새 v2 변수가 생성된다. //클래스 A가 인스턴스 변수를 생성할때 레퍼런스 p2에 인스턴스 변수를 저장한다
    p2.v2 = 300;//

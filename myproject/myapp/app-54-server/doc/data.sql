...
insert into myapp_member(member_no, name, email, age, weight, password, gender) 
  values(1, 'aaa', 'aaa@test.com', '20', '40', '1111', 'W');
insert into myapp_member(member_no, name, email, age, weight, password, gender) 
  values(2, 'bbb', 'bbb@test.com', '20', '40', '1111', 'M');
insert into myapp_member(member_no, name, email, age, weight, password, gender) 
  values(3, 'ccc', 'ccc@test.com', '20', '40', '1111', 'W');
insert into myapp_member(member_no, name, email, age, weight, password, gender) 
  values(4, 'ddd', 'ddd@test.com', '20', '40', '1111', 'M');
insert into myapp_member(member_no, name, email, age, weight, password, gender) 
  values(5, 'eee', 'eee@test.com', '20', '40', '1111', 'W');
insert into myapp_member(member_no, name, email, age, weight, password, gender) 
  values(6, 'fff', 'fff@test.com', '20', '40', '1111', 'M');
